...
class _$GithubRepoDTOTearOff {
  ...
  _GithubRepoDTO call(
      ...
      @JsonKey(fromJson: descriptionFromJson) required String description,
...
mixin _$GithubRepoDTO {
  ...
  @JsonKey(fromJson: descriptionFromJson)
...
abstract class $GithubRepoDTOCopyWith<$Res> {
  ...
  $Res call(
      {UserDTO owner,
      String name,
      @JsonKey(fromJson: descriptionFromJson) String description,
...
class _$_GithubRepoDTO extends _GithubRepoDTO {
  const _$_GithubRepoDTO(
      {required this.owner,
      required this.name,
      @JsonKey(fromJson: descriptionFromJson) required this.description,
