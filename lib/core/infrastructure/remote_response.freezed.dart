...
class _$RemoteResponseTearOff {
  ...
  _WitNewData<T> withNewData<T>(T data, {required int maxPage}) {
...
class _$_WitNewData<T> extends _WitNewData<T> {
  const _$_WitNewData(this.data, {required this.maxPage}) : super._();
...
abstract class _WitNewData<T> extends RemoteResponse<T> {
  const factory _WitNewData(T data, {required int maxPage}) = _$_WitNewData<T>;
